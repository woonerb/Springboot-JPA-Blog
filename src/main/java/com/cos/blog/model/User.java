...
public class User {
	...
	@Column(nullable = false, length = 30) 		// null될수 없으며 길이가 30이다
	private int         id ;  		            // 시퀀스, auto_increment
	
	@Column(nullable = false, length = 30) 		//  null될수 없으며길이가 30이다
	private String 		username;  // 아이디

	@Column(nullable = false, length = 100) 	//  null될수 없으며길이가 100이다
	...
	private RoleType 	role;	 //String이 아닌 Enum으로 //ADMIN, USER, mananger 중에서만 선택할 수 있게 한다	
